...
@Component({
  selector: 'app-fair-dashborad',
  templateUrl: './fair-dashborad.component.html',
  styleUrls: ['./fair-dashborad.component.scss']
})
export class FairDashboradComponent implements OnInit {
...
selectedFair !: Ifair;
  ...
  ngOnInit(): void {
    this.selectedFair = this.fairArray[0]
  }
